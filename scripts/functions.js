...
function printOutput(element){
	...
	$.getJSON(url, function(data){
		...
		Object.keys(data.query.pages).forEach(function(index){
			...
			var listItem = "<div class=\"card horizontal\"><div class=\"card-image\">" + img + "</div><div class=\"card-stacked\"><div class=\"card-content\"><span class=\"card-title\">" + title + "</span>" + extract + "</div>" + "<div class=\"card-action\"><a target='_blank' class=\"blue-text\" href=\"" + link + "\">More info</a></div></div></div>";
